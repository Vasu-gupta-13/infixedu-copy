...
import 'package:infixedu_copy/utils/models/attendance.dart';
import 'package:infixedu_copy/utils/models/global_class.dart';
...
class StudentListAttendance extends StatefulWidget {
  ...
  StudentListAttendance(
      {super.key, this.classCode, this.sectionCode, this.url, this.date, this.token});
